...
$string['deleteemptysections'] = 'Delete all empty sections';
$string['deleteemptysectionsdesc'] = 'Are you absolutely sure you want to completely delete all empty sections from this course?';
