...
$string['unoconvpagelimit'] = 'Maximum number of converted pages per file.';
$string['unoconvpagelimitdesc'] = 'The maximum number of pages per file that unoconv will attempt to convert. If set to zero, there is no limit.';
